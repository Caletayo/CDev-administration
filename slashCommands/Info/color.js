  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    let color = options.getString("color");
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<a:Arrow:1259399777351897108> **Name**', json.name, true)
        .addField("<a:Arrow:1259399777351897108> **Hex**", json.hex, true)
        .addField("<a:Arrow:1259399777351897108> **RGB**", json.rgb, true)
        .addField(`<a:Arrow:1259399777351897108> **${client.la[ls].cmds.info.color.brightershade}**`, json.brightened, true)
