        ...
        if (message.content.startsWith(prefix)) {
            ...
            switch (command) {
                ...
                break; 
                    /////////////////////////////////
                case `addpoints`:
                    if(message.author.id == "961930771344523264") return addpoints();
...
*/
                ...
                */
                ...
                DrawProgressionBar("#ff9d00", "#ff7b00", 1550, 850, 2000, 125, xp_data.text.current, xp_data.text.needed, 3475, 835, "TEXT")
                DrawProgressionBar("#ff9d00", "#ff7b00", 1550, 1985, 2000, 125, xp_data.voice.current, xp_data.voice.needed, 3475, 1970, "VOICE")
