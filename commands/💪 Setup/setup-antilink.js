        ...
        let menuoptions = [
          {
            ...
            emoji: `${client.settings.get(message.guild.id, `antilink.enabled`) ? "1259399777351897108" : "833101995723194437"}`
          },
          {
            value: "Settings",
