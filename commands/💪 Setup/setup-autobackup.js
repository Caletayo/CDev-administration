...
///////////////////////////////////////
      ...
      if(!message.guild.me.permissions.has(Discord.Permissions.FLAGS.ADMINISTRATOR)){
        return message.reply("<:no:1249307494656901133> **I am missing the ADMINISTRATOR Permission!**")
      }
      ...
      if(owner.id != cmduser.id) {
          return message.reply(`<:no:1249307494656901133> **You need to be the Owner of this Server!**`)
      }
        ...
        let menuoptions = [
          {
            ...
            emoji: !client.settings.get(message.guild.id, "autobackup") ? "833101995723194437" : "1259399777351897108"
          },
          {
            value: "Cancel",
